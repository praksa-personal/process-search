...
if __name__ == '__main__':
    client = paho.Client(client_id="Tester-1", clean_session=True,
                         userdata=None, protocol=paho.MQTTv31)
    ...
    if(x == 'y'):
        ...
        print("Test started")
        os.startfile(
            "C:/Users/puntaric/Projekti/process-search/exe/dist/test.exe")
        ...
        gone, alive = psutil.wait_procs(
            procs_list, timeout=run_time, callback=proc.on_terminate)
        x = 'n'
        print("Test finished")
